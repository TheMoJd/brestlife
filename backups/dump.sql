...
INSERT INTO public.categories (id, created_at, sub_category, type, created_by) VALUES
...
INSERT INTO public.deals (id, created_at, description, link, title, updated_at, category_id, created_by, company, date_end, new_price, old_price, reserve) VALUES
                                                                                                                                                               ...
                                                                                                                                                               (2, '2025-02-14 15:30:00', 'Promotion spéciale : 2 plats pour le prix d''un.', 'https://restaurant.com', 'Offre Restaurant', '2025-02-15 15:30:00', 3, 2, 'Restaurant Gourmand', '2025-02-28 00:00:00', 15.00, 30.00, 'Tous');

-- Data for Name: events; Type: TABLE DATA; Schema: public; Owner: dev
INSERT INTO public.events (id, created_at, date, description, image_url, location, price, title, category_id, created_by) VALUES
                                                                                                                              (1, '2025-02-09 11:46:10', '2025-02-15 19:00:00', 'Concert de jazz avec des artistes locaux.', '/img/concert.jpg', 'Salle de Concert de Brest', 20.00, 'Concert de Jazz', 1, 1),
                                                                                                                              (2, '2025-02-10 12:00:00', '2025-02-16 10:00:00', 'Conférence sur l''intelligence artificielle.', '/img/conference.jpg', 'Université de Brest', 10.00, 'Conférence IA', 1, 3);

-- Data for Name: jobs; Type: TABLE DATA; Schema: public; Owner: dev
INSERT INTO public.jobs (id, company_name, contact_email, created_at, description, duration, end_date, location, start_date, title, category_id, created_by) VALUES
...
INSERT INTO public.places (id, address, created_at, description, image_url, latitude, longitude, name, category_id, created_by, price) VALUES
                                                                                                                                           (1, '123 Rue de la Plage, Brest', '2025-02-09 11:47:00', 'Plage idéale pour la baignade et les sports nautiques.', '/img/plage.jpg', 48.3833, -4.4833, 'Plage de Brest', 3, 1, 0.00),
                                                                                                                                           (2, '456 Rue du Centre, Brest', '2025-02-10 12:30:00', 'Centre commercial avec de nombreuses boutiques.', '/img/centre_commercial.jpg', 48.3900, -4.4700, 'Centre Commercial de Brest', 3, 2, 0.00);

-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: dev
INSERT INTO public.users (id, name, email, password, created_at, role, updated_at) VALUES
...
ALTER TABLE ONLY public.categories ADD CONSTRAINT ukt806pivur7nn124jehx7cygw5 UNIQUE (sub_category);
...
ALTER TABLE ONLY public.categories ADD CONSTRAINT fk5yfru0au6kpyqs4tonky5vfne FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: deals fk9tii7qhrwtm0t22p08yp38p5b; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.deals ADD CONSTRAINT fk9tii7qhrwtm0t22p08yp38p5b FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: jobs fkag1hj06pxsv6fexoubroe6mn4; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.jobs ADD CONSTRAINT fkag1hj06pxsv6fexoubroe6mn4 FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: places fkayjup44mff03nvy1v9u2m7184; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.places ADD CONSTRAINT fkayjup44mff03nvy1v9u2m7184 FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: places fkca17w9kt9f18v0lr91ssmivx5; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.places ADD CONSTRAINT fkca17w9kt9f18v0lr91ssmivx5 FOREIGN KEY (category_id) REFERENCES public.categories(id);

-- Name: jobs fklunrv9ems34544ff26wyfa89v; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.jobs ADD CONSTRAINT fklunrv9ems34544ff26wyfa89v FOREIGN KEY (category_id) REFERENCES public.categories(id);

-- Name: events fkmpv90allsx91cxsj7xjcvvsxg; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.events ADD CONSTRAINT fkmpv90allsx91cxsj7xjcvvsxg FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: events fko6mla8j1p5bokt4dxrlmgwc28; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.events ADD CONSTRAINT fko6mla8j1p5bokt4dxrlmgwc28 FOREIGN KEY (category_id) REFERENCES public.categories(id);

-- Name: deals fkpnyh4swmor0cfhfjaefm5o9gh; Type: FK CONSTRAINT; Schema: public; Owner: dev
ALTER TABLE ONLY public.deals ADD CONSTRAINT fkpnyh4swmor0cfhfjaefm5o9gh FOREIGN KEY (category_id) REFERENCES public.categories(id);

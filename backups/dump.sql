...
CREATE TABLE public.categories (
    ...
    created_by integer,
    CONSTRAINT categories_type_check CHECK (((type)::text = ANY (ARRAY[('PLACE'::character varying)::text, ('JOB'::character varying)::text, ('EVENT'::character varying)::text])))
);
...
COPY public.categories (id, created_at, name, type, created_by) FROM stdin;
2	2025-02-09 11:47:00	test	PLACE	1
4	2025-02-13 14:56:43	deal	EVENT	1
\.
...
1	2025-02-13 14:55:48	Lorem ipsum odor amet, consectetuer adipiscing elit. Montes cursus hendrerit rutrum; condimentum per facilisis. Aliquet lobortis lacus nostra lacus conubia.\n\n	https://google.com	Un deal	\N	2	1	Crous	\N	3.5	5.5	Pour les étudiants
\.
...
1	2025-02-09 11:46:10	2025-02-09 11:46:18	description	/img/ig.jpg	Brest	12	Test	2	1
\.
...
1	Test	test@example.com	haspswd	2025-02-09 11:45:17	ADMIN	\N
\.
...
--
-- Name: categories ukt8o6pivur7nn124jehx7cygw5; Type: CONSTRAINT; Schema: public; Owner: dev
--
...
--
-- Name: events fkmpv90a1lsx9lcxsj7xjcvvsxg; Type: FK CONSTRAINT; Schema: public; Owner: dev
--
